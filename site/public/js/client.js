...
function showResultBox() {
    ...
    if(userScore > 5){
        let scoreTag = '<span>e parabéns! Você acertou apenas <p>'+ userScore +'</p> de <p>'+ questions.length +'</p></span>'
        scoreText.innerHTML = scoreTag;
    }
    else if(userScore > 3){
        let scoreTag = '<span>Boa, Mas você acertou apenas <p>'+ userScore +'</p> de <p>'+ questions.length +'</p></span>'
        scoreText.innerHTML = scoreTag;
    }
    else{
        let scoreTag = '<span>Desculpa, bas você acertou apenas '+ userScore +' de '+ questions.length +'</span>'
        scoreText.innerHTML = scoreTag;
    }
}
